  ...
  return (
    <section className="py-16 bg-background-dark border-b border-border-dark">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-4 font-mono">Earn Your Logic Certificate</h2>
        <p className="text-gray-400 max-w-2xl mx-auto mb-8 font-light">
          Upon completion, you'll receive a personalized <strong className="text-white">Aptitude Report</strong>. Even if you decide not to pursue coding, you'll have a certified analysis of your logical problem-solving skills.
        </p>
