      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-2 lg:order-2">
          ...
          <p className="text-gray-400 text-lg mb-8">
            ...
            Eu sou <strong>Coordenador de Engenharia de Software</strong> com
            +20 anos de campo de batalha.
          </p>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center gap-4 p-4 bg-surface-dark rounded-lg border border-border-dark">
              ...
              <div>
                <strong className="text-white block text-xl font-mono">
                  +300 Contratações Realizadas
                </strong>
                <span className="text-gray-400 text-sm">
                  (Do estagiário ao Sênior)
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-surface-dark rounded-lg border border-border-dark">
              ...
              <div>
                <strong className="text-white block text-xl font-mono">
                  +700 Currículos Analisados
                </strong>
                <span className="text-gray-400 text-sm">
                  (Eu sei o que é descartado em 5 segundos)
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-surface-dark rounded-lg border border-border-dark">
              ...
              <div>
                <strong className="text-white block text-xl font-mono">
                  +400 Mentorias Individuais
                </strong>
                <span className="text-gray-400 text-sm">
                  (Eu conheço as travas de quem está começando)
                </span>
              </div>
            </div>
          </div>
          ...
          <p className="text-lg italic text-gray-400 border-l-4 border-primary pl-6">
            "Eu não estou aqui para te agradar. Estou aqui para te dar a
            segurança que ninguém mais teve coragem de te dar."
          </p>
        </div>
      </div>
    </section>
