        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12 text-left max-w-2xl mx-auto">
          <div className="bg-red-500/10 border border-red-500/20 p-6 rounded-lg">
            <p className="text-gray-300">
              Se você descobrir que Tecnologia{' '}
              <span className="text-red-400 font-bold">NÃO é para você</span>,
              você economizou milhares de reais e anos de frustração.
            </p>
          </div>
          <div className="bg-primary/10 border border-primary/20 p-6 rounded-lg">
            <p className="text-gray-300">
              Se você descobrir que Tecnologia{' '}
              <span className="text-primary font-bold">É para você</span>, você
              entra no jogo com confiança total e um plano validado.
            </p>
          </div>
        </div>
