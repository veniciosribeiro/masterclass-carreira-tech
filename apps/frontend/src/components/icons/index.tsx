...
export const SentimentWorriedIcon: React.FC<IconProps> = ({
  className = '',
}) => (
  <svg
    className={className}
...
export const WorkspacePremiumIcon: React.FC<IconProps> = ({
  className = '',
}) => (
  <svg
    className={className}
...
export const SettingsSystemDaydreamIcon: React.FC<IconProps> = ({
  className = '',
}) => (
  <svg
    className={className}
