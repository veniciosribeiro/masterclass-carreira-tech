...
export const EXPLANATIONS = {
  areas: {
    frontend: {
      ...
      medium:
        'Você compreende bem a importância da interface, mas talvez seu interesse técnico esteja dividido com outras camadas da aplicação.',
    ...
    backend: {
      ...
      medium:
        'Você entende a estrutura dos sistemas, mas pode preferir trabalhar em componentes onde o resultado seja mais visível ou menos abstrato.',
    ...
    dataAI: {
      ...
      medium:
        'Você valoriza dados para embasar decisões, mas seu interesse principal pode estar mais na construção de aplicações do que na análise pura.',
  ...
  behavioral: {
    resilience: {
      ...
      medium:
        'Você lida bem com problemas até certo ponto, mas pode se beneficiar de pausas estratégicas para não deixar a frustração afetar sua produtividade.',
    ...
    logic: {
      ...
      medium:
        'Você consegue seguir raciocínios lógicos, mas em cenários de alta pressão ou complexidade, pode precisar de ferramentas externas (desenhos, anotações) para se organizar.',
    ...
    proactivity: {
      ...
      medium:
        'Você executa bem o que é pedido e resolve problemas quando surgem, mas talvez não tenha o hábito de caçar melhorias proativamente.',
...
export function generateExplanations(scores: NormalizedScores) {
  const areaExplanations: Record<AreaKey, string> = {
    frontend:
      EXPLANATIONS.areas.frontend[getLevel(scores.areasPercent.frontend)],
  ...
  const behavioralExplanations: Record<keyof BehavioralScores, string> = {
    resilience:
      EXPLANATIONS.behavioral.resilience[
        getLevel(scores.behavioralPercent.resilience)
      ],
    logic:
      EXPLANATIONS.behavioral.logic[getLevel(scores.behavioralPercent.logic)],
    proactivity:
      EXPLANATIONS.behavioral.proactivity[
        getLevel(scores.behavioralPercent.proactivity)
      ],
  };
